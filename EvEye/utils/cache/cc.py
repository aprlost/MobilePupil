...
def main():
    ...
    events_path = (
        "D:/A/FACET-main/makemake1/train/cached_data"
    )
...
if __name__ == "__main__":
    main()
'''
    ellipses_path = "D:/A/FACET-main/anothermake/train/cached_ellipse"
    ellipses_list = load_cached_structed_ellipses(ellipses_path)
    print(len(ellipses_list[1]))

    events_path = (
        "D:/A/FACET-main/anothermake/train/cached_data"
    )
    events = load_cached_structed_events(events_path)
    print(len(events))
        cache_structed_events(
        1,
        "D:/A/FACET-main/hang_make_del/train/data",
        "D:/A/FACET-main/makemake1/train",
        0
    )
'''